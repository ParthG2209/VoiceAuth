...
from app.models.ensemble import ensemble_detector
...
@router.post(
    ...
    description=(
        ...
        "Uses ensemble of feature-based and Wav2Vec2 deep learning models."
    )
)
async def detect_voice(
    request: VoiceDetectionRequest,
    api_key: str = Depends(validate_api_key),
    use_deep_learning: bool = Query(
        default=True,
        description="Use Wav2Vec2 deep learning model (slower but more accurate)"
    )
) -> VoiceDetectionResponse:
    """
    ...
    4. Run ensemble detection (feature-based + Wav2Vec2)
    ...
    logger.info(
        ...
        f"Deep Learning: {use_deep_learning}"
    )
    ...
    try:
        ...
        # Step 2: Run ensemble voice detection
